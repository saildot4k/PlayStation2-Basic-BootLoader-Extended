...
- Filename: `LOGO.PNG` (uppercase only)
- Required dimensions: `256 x 64`
- Supported PNG color formats are normalized to 8-bit RGBA at load time

Place `LOGO.PNG` in the same CWD where PS2BBL resolves `CONFIG.INI`.
